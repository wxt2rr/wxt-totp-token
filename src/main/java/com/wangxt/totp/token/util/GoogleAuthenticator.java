...
public class GoogleAuthenticator {
    ...
    public static final int SECRET_SIZE = "".length();
    ...
    public static void main(String[] args) {
        int i = 0;
        try {
            String s = GoogleAuthenticator.generateSecretKey();

            i = GoogleAuthenticator.verify_code(s.getBytes(StandardCharsets.UTF_8), (System.currentTimeMillis() / 1000L) / 30L);
        } catch (NoSuchAlgorithmException e) {
            e.printStackTrace();
